...
if(isset($_POST['fullname'])) {
    ...
    if (mysqli_connect_error()) {
        ...
        $INSERT = "INSERT INTO eshop.users (username, userpass, user_fullname, user_gender, user_dob, user_email) VALUES (?, ?, ?, ?, ?, ?)";
        if ($stmt = $conn->prepare($SELECT)) {
            ...
            if ($result->num_rows > 0) { 
                ...
                $stmt->bind_param('issssd', $username, $password, $fullname, $gender, $birthdate, $emailAdd);
                $stmt->execute();
