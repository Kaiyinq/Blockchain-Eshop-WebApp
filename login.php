				...
				<div class="pull-right">
					<ul class="header-top-links">
						...
						<li class="dropdown default-dropdown">
							<a data-toggle="dropdown" aria-expanded="true">ENG <i class="fa fa-caret-down"></i></a>
						...
						<li class="dropdown default-dropdown">
							<a data-toggle="dropdown" aria-expanded="true">USD <i class="fa fa-caret-down"></i></a>
							<ul class="custom-menu">
								<li><a href="#">USD ($)</a></li>
								<li><a href="#">EUR (€)</a></li>
							</ul>
				...
				<div class="category-nav show-on-click">
					...
					<ul class="category-list">
						<li class="dropdown side-dropdown">
							<a data-toggle="dropdown" aria-expanded="true">Women’s Clothing <i class="fa fa-angle-right"></i></a>
							<div class="custom-menu">
								<div class="row">
									<div class="col-md-4">
										<ul class="list-links">
						...
						<li><a href="#">Men’s Clothing</a></li>
						<li class="dropdown side-dropdown"><a data-toggle="dropdown" aria-expanded="true">Phones & Accessories <i class="fa fa-angle-right"></i></a>
							<div class="custom-menu">
								<div class="row">
									<div class="col-md-4">
										<ul class="list-links">
						...
						<li class="dropdown side-dropdown">
							<a data-toggle="dropdown" aria-expanded="true">Jewelry & Watches <i class="fa fa-angle-right"></i></a>
							<div class="custom-menu">
								<div class="row">
									<div class="col-md-4">
										<ul class="list-links">
