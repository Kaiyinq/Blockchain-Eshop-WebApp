...
if(isset($_SESSION["buyerid"])) {
    ...
    echo "<li><a href='checkout.php'><i class='fa fa-shopping-cart'></i> Checkout</a></li>";
    ...
    // echo "<button class='primary-btn' id='checkout'>Checkout <i class='fa fa-arrow-circle-right'></i></button>";
    // echo "</div>";
    // echo "</div>";
    // echo "</div>";
    // echo "</li>";
