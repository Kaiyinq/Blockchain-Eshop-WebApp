...
<body>
                    ...
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <form id="status-form" class="form" action="#" method="post" enctype="multipart/form-data">
                                <h3 class="text-center">Update Order Status</h3>
								<div class="form-group">
                                    <label for="orderstatus">Order Status:</label><br>
                                    <select class="input" id="orderstatus" name="orderstatus">
                                ...
                                <div class="form-group">
									<button class="primary-btn pull-right" type="button" name="submitBtn" id="submitBtn">Update</button>
								</div>
                            </form>
                        </div>
                    </div>					                
    ...
    <script src="js/sellUpdateStatus.js"></script>
